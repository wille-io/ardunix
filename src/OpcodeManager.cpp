...
#warning unused
	return false; // fuck off, stack is full, no program exit
...
// for executing api functions
/*void OpcodeManager::opcodeSEI()
{
	/*
		  * Set Global ubyte2errupt Flag.
		  *
...
void OpcodeManager::opcodeJMP(ubyte2 k) // Rücksprache Mike [ 32 BIT !!!!!!!!!!!!!!!!!1 ]
{
  DEBUG_HEAD(JMP);
...
//void OpcodeManager::opcodeLD_X(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//       /* X is R27:R26 */
//       X = (avr_core_gpwr_get(27) << 8) + avr_core_gpwr_get(26);

//       avr_core_gpwr_set(Rd, avr_core_mem_read(X));

//       cpu->incPC();
//       //avr_core_inst_CKS_set(2);
//   }

//void OpcodeManager::opcodeLD_X_decr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//       X -= 1;
//       avr_core_gpwr_set(26, X & 0xff);
//       avr_core_gpwr_set(27, X >> 8);
...
//void OpcodeManager::opcodeLD_X_incr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//void OpcodeManager::opcodeLD_Y_decr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//       /* Y is R29:R28 */
//       Y = (avr_core_gpwr_get(29) << 8) + avr_core_gpwr_get(28);

//       /* Perform pre-decrement */
//       Y -= 1;
//       avr_core_gpwr_set(28, Y & 0xff);
//       avr_core_gpwr_set(29, Y >> 8);

//       avr_core_gpwr_set(Rd, avr_core_mem_read(Y));

//       cpu->incPC();
//       //avr_core_inst_CKS_set(2);
//   }

//void OpcodeManager::opcodeLD_Y_incr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//void OpcodeManager::opcodeLD_Z_incr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//       /* Z is R31:R30 */
//       Z = (avr_core_gpwr_get(31) << 8) + avr_core_gpwr_get(30);

//       avr_core_gpwr_set(Rd, avr_core_mem_read(Z));

//       /* Perform post-increment */
//       Z += 1;
//       avr_core_gpwr_set(30, Z & 0xff);
//       avr_core_gpwr_set(31, Z >> 8);

//       cpu->incPC();
//       //avr_core_inst_CKS_set(2);
//   }

//void OpcodeManager::opcodeLD_Z_decr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
...
//void OpcodeManager::opcodeLPM_Z(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
//        * Load Program Memory.
//        *
...
//       if(high_ubyte2 == 1)
//           avr_core_gpwr_set(Rd, data >> 8);
//       else
//           avr_core_gpwr_set(Rd, data & 0xff);

//       cpu->incPC();
//       avr_core_inst_CKS_set(3);
//   }

//void OpcodeManager::opcodeLPM(ubyte2 arg1, ubyte2 arg2)
//   {
//       /* Load Program Memory.
//        *
...
//        * Num Clocks : 3
//        */
//       return avr_op_LPM_Z(0x9004, 0, arg2);
//   }

//void OpcodeManager::opcodeLPM_Z_incr(ubyte2 arg1, ubyte2 arg2)
//   {
//       /*
